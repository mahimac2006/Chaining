...
define dso_local i32 @main() local_unnamed_addr #0 !dbg !31 {
  ...
  %25 = getelementptr inbounds i8, i8* %24, i64 8, !dbg !61
  call void @klee_make_symbolic(i8* noundef %25, i64 noundef 4, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0)), !dbg !62
  %26 = load i8*, i8** %3, align 8, !dbg !63
  %27 = getelementptr inbounds i8, i8* %26, i64 12, !dbg !64
  %28 = load %struct.netdissect_options*, %struct.netdissect_options** %2, align 8, !dbg !65
  %29 = getelementptr inbounds %struct.netdissect_options, %struct.netdissect_options* %28, i32 0, i32 1, !dbg !66
  store i8* %27, i8** %29, align 8, !dbg !67
  %30 = load %struct.netdissect_options*, %struct.netdissect_options** %2, align 8, !dbg !68
  %31 = load i8*, i8** %3, align 8, !dbg !69
  %32 = load i32, i32* %4, align 4, !dbg !70
  call void @smb_tcp_print(%struct.netdissect_options* noundef %30, i8* noundef %31, i32 noundef %32), !dbg !71
  ret i32 0, !dbg !72
}
...
!1 = !DIFile(filename: "/app/se_runs/sailor_engine/tcpdump-4.9.2/102_print-smb.c_1260_local_cpp_cwe-125-oob-read/harness/driver.c", directory: "/app/se_runs/sailor_engine/tcpdump-4.9.2/102_print-smb.c_1260_local_cpp_cwe-125-oob-read/harness", checksumkind: CSK_MD5, checksum: "537ff8561c12cd958c4a3a4a9ca0ddbe")
!2 = !{!3, !18, !14}
!3 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4, size: 64)
!4 = !DIDerivedType(tag: DW_TAG_typedef, name: "netdissect_options", file: !5, line: 10, baseType: !6)
!5 = !DIFile(filename: "driver.c", directory: "/app/se_runs/sailor_engine/tcpdump-4.9.2/102_print-smb.c_1260_local_cpp_cwe-125-oob-read/harness", checksumkind: CSK_MD5, checksum: "537ff8561c12cd958c4a3a4a9ca0ddbe")
...
!31 = distinct !DISubprogram(name: "main", scope: !5, file: !5, line: 14, type: !32, scopeLine: 14, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !34)
!32 = !DISubroutineType(types: !33)
!33 = !{!10}
!34 = !{}
!35 = !DILocalVariable(name: "ndo", scope: !31, file: !5, line: 15, type: !3)
!36 = !DILocation(line: 15, column: 25, scope: !31)
!37 = !DILocation(line: 15, column: 53, scope: !31)
!38 = !DILocation(line: 15, column: 31, scope: !31)
!39 = !DILocalVariable(name: "buf", scope: !31, file: !5, line: 16, type: !18)
!40 = !DILocation(line: 16, column: 20, scope: !31)
!41 = !DILocation(line: 16, column: 43, scope: !31)
!42 = !DILocalVariable(name: "len", scope: !31, file: !5, line: 17, type: !10)
!43 = !DILocation(line: 17, column: 9, scope: !31)
!44 = !DILocation(line: 19, column: 5, scope: !31)
!45 = !DILocation(line: 19, column: 12, scope: !31)
!46 = !DILocation(line: 20, column: 5, scope: !31)
!47 = !DILocation(line: 20, column: 12, scope: !31)
!48 = !DILocation(line: 21, column: 5, scope: !31)
!49 = !DILocation(line: 21, column: 12, scope: !31)
!50 = !DILocation(line: 22, column: 5, scope: !31)
!51 = !DILocation(line: 22, column: 12, scope: !31)
!52 = !DILocation(line: 23, column: 5, scope: !31)
!53 = !DILocation(line: 23, column: 12, scope: !31)
!54 = !DILocation(line: 24, column: 5, scope: !31)
!55 = !DILocation(line: 24, column: 12, scope: !31)
!56 = !DILocation(line: 25, column: 5, scope: !31)
!57 = !DILocation(line: 25, column: 12, scope: !31)
!58 = !DILocation(line: 26, column: 5, scope: !31)
!59 = !DILocation(line: 26, column: 12, scope: !31)
!60 = !DILocation(line: 28, column: 24, scope: !31)
!61 = !DILocation(line: 28, column: 28, scope: !31)
!62 = !DILocation(line: 28, column: 5, scope: !31)
!63 = !DILocation(line: 29, column: 24, scope: !31)
!64 = !DILocation(line: 29, column: 28, scope: !31)
!65 = !DILocation(line: 29, column: 5, scope: !31)
!66 = !DILocation(line: 29, column: 10, scope: !31)
!67 = !DILocation(line: 29, column: 22, scope: !31)
!68 = !DILocation(line: 31, column: 19, scope: !31)
!69 = !DILocation(line: 31, column: 40, scope: !31)
!70 = !DILocation(line: 31, column: 45, scope: !31)
!71 = !DILocation(line: 31, column: 5, scope: !31)
!72 = !DILocation(line: 32, column: 5, scope: !31)
